...
bool PersistResourceKeyFilterByType::QueryInterface(uint32_t riid, void** ppvObj)
{
...
uint32_t PersistResourceKeyFilterByType::AddRef()
{
	return cRZBaseUnknown::AddRef();
}

uint32_t PersistResourceKeyFilterByType::Release()
{
