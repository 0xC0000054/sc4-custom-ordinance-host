...
class BuildingCountAvailabilityCondition : public IAvailabilityCondition
{
public:
	BuildingCountAvailabilityCondition();
	BuildingCountAvailabilityCondition(BuildingType type, uint32_t minBuildingCount);
