...
class RCIGroupPopulationAvailabilityCondition : public IAvailabilityCondition
{
public:
	RCIGroupPopulationAvailabilityCondition();
	RCIGroupPopulationAvailabilityCondition(RCIGroup group, int32_t minPopulation);
