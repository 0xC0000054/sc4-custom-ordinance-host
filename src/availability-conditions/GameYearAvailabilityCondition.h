...
class GameYearAvailabilityCondition : public IAvailabilityCondition
{
public:
	GameYearAvailabilityCondition();
	GameYearAvailabilityCondition(uint32_t yearFirstAvailable);
