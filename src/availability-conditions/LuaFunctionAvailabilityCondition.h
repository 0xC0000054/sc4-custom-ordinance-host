...
class LuaFunctionAvailabilityCondition : public IAvailabilityCondition
{
public:
	LuaFunctionAvailabilityCondition();
	LuaFunctionAvailabilityCondition(const cRZBaseString& name);
