...
class TotalResidentialPopulationIncomeFactor : public IMonthlyIncomeFactor
{
public:
	TotalResidentialPopulationIncomeFactor();
	TotalResidentialPopulationIncomeFactor(float factor);
